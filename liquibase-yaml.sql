...
-- Dumping structure for table appdb.addresses
...
-- Dumping data for table appdb.addresses: ~2 rows (approximately)
...
-- Dumping structure for table appdb.databasechangelog
...
-- Dumping data for table appdb.databasechangelog: ~3 rows (approximately)
...
-- Dumping structure for table appdb.databasechangeloglock
...
-- Dumping data for table appdb.databasechangeloglock: ~1 rows (approximately)
...
INSERT INTO `users` (`ID`, `NAME`, `EMAIL`, `PHONE`, `ADDRESS`) VALUES
	(1, 'James', 'james@email.com', NULL, 1),
	(2, 'Frank', 'frank@email.com', 1234567890, 2);
